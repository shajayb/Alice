...
void setup()
{
	...
	sc[0] = sc[1] = 1;
	sc[2] = 0.1;
	RC1.setScale(sc); RC2.setScale(sc); RC3.setScale(sc);
	RC1.transform(); RC2.transform(); RC3.transform();
	...
	transM.setColumn(3, vec(0.1, 0.1, 0.12));
